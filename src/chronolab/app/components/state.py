...
@cache_data(show_spinner="Cargando metricas de deteccion...")
...
@cache_data(show_spinner="Cargando eventos anomalos...")
...
@cache_data(show_spinner="Cargando interpretabilidad del TFT...")
...
@cache_data(show_spinner="Cargando la descomposicion MSTL...")
...
@cache_data(show_spinner="Cargando predicciones...")
